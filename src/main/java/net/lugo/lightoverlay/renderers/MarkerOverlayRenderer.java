...
public class MarkerOverlayRenderer extends CachedMeshOverlayRenderer {
    ...
    protected void addVertices(float worldX, float worldY, float worldZ, OverlayRendererBlockData data) {
        ...
        OverlayVertexHelper.rect(buffer, OverlayVertexHelper.FixedAxis.Y, y1, x0, z0, x1, z1, r, g, b, 0f, 0f, 1f, 1f, UVRotation.NONE); // Top
        OverlayVertexHelper.rect(buffer, OverlayVertexHelper.FixedAxis.Y, y0, x0, z1, x1, z0, r, g, b, 0f, 0f, 1f, 1f, UVRotation.NONE); // Bottom
        OverlayVertexHelper.rect(buffer, OverlayVertexHelper.FixedAxis.X, x0, y0, z0, y1, z1, r, g, b, 0f, 0f, 1f, 1f, UVRotation.NONE); // West
        OverlayVertexHelper.rect(buffer, OverlayVertexHelper.FixedAxis.X, x1, y0, z1, y1, z0, r, g, b, 0f, 0f, 1f, 1f, UVRotation.NONE); // East
        OverlayVertexHelper.rect(buffer, OverlayVertexHelper.FixedAxis.Z, z0, x0, y0, x1, y1, r, g, b, 0f, 0f, 1f, 1f, UVRotation.NONE); // North
        OverlayVertexHelper.rect(buffer, OverlayVertexHelper.FixedAxis.Z, z1, x0, y1, x1, y0, r, g, b, 0f, 0f, 1f, 1f, UVRotation.NONE); // South
    }
}